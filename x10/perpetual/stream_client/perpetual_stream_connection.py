...
class PerpetualStreamConnection(Generic[StreamMsgResponseType]):
    ...
    async def __await_impl__(self):
        ...
        if self.__api_key is not None:
            additional_headers[RequestHeader.API_KEY] = self.__api_key

        self.__websocket = await websockets.connect(self.__stream_url, additional_headers=additional_headers)
